...
# whistler_dates contains the dates in y-m-d format, and  whistler_data contains the total snow in cm.
...
"""STEP 3: Saatci et al. log-transform the data"""

if log_transform:
    data = np.log(data + 1)

"""STEP 4: Saatci et al. normalize the data"""
...
# intercept_scale=0 corresponds to saying that our prior belief is that no snow falls (because minimum is like zero
# before the normalized log transform)
intercept_scale = 0
prior_var_scale = 1
hyperpar_opt = "caron"
...
"""Step 11: Output performance indicators for the paper"""
