...
baseline_working_directory = baseline_working_directory + "//Data//APData"
...
numparam = 0
for e in res_seq_list:
    numparam = numparam+len(e)*(len(e[0]) + 1)
numparam = numparam * 29 #for each station
numparam = numparam + len(res_seq_list) #for variance param
numparam = numparam + 29*3 #for AR(1)
